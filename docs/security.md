...
Кожен endpoint перевіряє permission, а не лише приховує кнопку у frontend. OWNER може делегувати дозволи користувачам через ролі, але системну роль OWNER не можна випадково видалити або позбавити критичних дозволів. Роль TEACHER додатково має row-level scope за `teacherId`: API не повертає чужі курси, заняття, учнів чи їхні фінансові дані та не дозволяє відмічати чуже заняття.
